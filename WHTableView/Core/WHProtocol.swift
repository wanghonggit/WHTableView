...
// MARK: - WHTableViewRowProtocol
public protocol WHRowProtocol where Self: WHTableViewRow {}
...
// MARK: - WHTableViewScrollDelegate
public protocol WHTableViewScrollDelegate: NSObjectProtocol {
    @available(iOS 2.0, *)
...
// MARK: - WHTableViewScrollDelegate Default Implementation
public extension WHTableViewScrollDelegate {
...
extension WHTableView: UIScrollViewDelegate {
